...
export default function AboutMe (){
    ...
    return(
        <div class="h-screen">
            <div className="hero card-side min-h-screen bg-base-200">
                ...
                <div className="hero-content text-center">
                    ...
                    <div class='justify-center flex flex-row space-x-5'>
                        {/* email */}
            <div class='cursor-pointer hover:animate-bounce' onClick={()=>navigator.clipboard.writeText('alvinstoch@gmail.com').then(alert('Email copied'))}>
            <svg class='active:stroke-accent' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M0 12l11 3.1 7-8.1-8.156 5.672-4.312-1.202 15.362-7.68-3.974 14.57-3.75-3.339-2.17 2.925v-.769l-2-.56v7.383l4.473-6.031 4.527 4.031 6-22z"/></svg>
            </div>
            {/* resume */}
            <div class='hover:animate-bounce'>
            <a href="https://docs.google.com/document/d/16W4dBNoibOvwIRULJA9x-_UcCvRaL-4SLfEG4i48PFw/edit?usp=sharing" target="_blank">
            ...
            {/* github */}
            <div class='hover:animate-bounce'>
            <a href="https://github.com/Anasterisk" target="_blank">
            ...
            {/*  linkedin */}
            <div class='hover:animate-bounce'>
            <a href="https://www.linkedin.com/in/alvin-toch/" target="_blank">
